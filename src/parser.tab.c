...
static const char *const yytname[] =
{
  ...
  "DIV", "GT", "LT", "EQ", "NEQ", "NOT", "WHILE", "FOR", "TRUE", "FALSE",
  "NUMBER", "IDENTIFIER", "STRING", "FUNCTION", "RETURN", "PRINT", "IF",
  "ELSE", "ASSIGN", "'('", "')'", "$accept", "program", "statement_list",
...
{
     -13,     0,     2,    22,   -13,   -14,   -10,     1,   -14,   -14,
     -14,   -14,     6,    -1,    -3,   -10,   -10,   -10,   -10,   -14,
     -14,    15,    15,   -14,   -14
};
...
{
      15,    16,    17,    18,     1,    14,    10,    11,     2,    15,
      16,    17,    18,    21,    22,    23,    24,    10,    11,    13,
      17,    18,     8,    20,     6,    19,     0,     7,     9
};

static const yytype_int8 yycheck[] =
{
       3,     4,     5,     6,    17,     7,    16,    17,    21,     3,
       4,     5,     6,    15,    16,    17,    18,    16,    17,    18,
       5,     6,     0,    26,    24,    26,    -1,    25,     4
};
...
{
       0,    17,    21,    28,    29,    30,    24,    25,     0,    30,
      16,    17,    31,    18,    31,     3,     4,     5,     6,    26,
      26,    31,    31,    31,    31
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 5: /* statement: IDENTIFIER ASSIGN expr  */
#line 67 "parser.y"
                           { set_variable((yyvsp[-2].sval), (yyvsp[0].ival)); free((yyvsp[-2].sval)); }
...
#line 78 "parser.y"
                 { (yyval.ival) = get_variable((yyvsp[0].sval)); free((yyvsp[0].sval)); }
...
int main() {
    printf("कार्यक्रमः आरभ्यताम्। स्वस्यं कोडं लिखत।।\n");
    return yyparse();
}
